          ...
          column(
            ...
            div(
              ...
              box(
                ...
                p(
                  "2024年3月18日：時系列による可視化にExportオプション追加", br(),
                  "2024年1月26日：解説タブを追加"
                )
              )
            )
          ...
          column(
            ...
            div(
              ...
              width = NULL,
                ...
                h4("第三者の権利"),
                p(
                  "本コンテンツは、「From-To分析（滞在人口）」（RESAS）および「統計地理情報システム」（e-Stat）の情報に基づいて作成しています。「From-To分析（滞在人口）」は「モバイル空間統計®」（NTTドコモ）に基づいたデータであり、RESAS APIを利用して2015年9月から2016年8月までの期間をダウンロードして使用しています。時系列による可視化はHighchartsをEducational License (License ID: 31250)のもとで利用しています。本コンテンツを利用する際は、第三者の権利を侵害しないようにしてください。"
                ),
                #--------------------
                h4("免責事項"),
                ...
                h3(style = "border-bottom: solid 1px black;", span(icon("calendar"), "更新履歴")),
              　p(
                  "2024年3月18日：「利用規約」の「第三者の権利」を更新", br(),
