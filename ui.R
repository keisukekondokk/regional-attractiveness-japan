        ...
        fluidRow(
          ...
          column(
            ...
            box(
              ...
              p("長野県山之内町は山間部にある町ですが、図7に示すように、地域魅力度指数は冬季(12月から3月)にかけて-0.5から-1の間で値が推移しています。山之内町は志賀高原や湯田中渋温泉郷等で知られる国内屈指の人気リゾート地であり、冬にはスキー場エリアとして人気もあることから、このような季節要因が地域魅力度指数に反映されていると考えられます。一方で、オフシーズンの時期には、-3程度まで下落してしまい、年間を通じて変動が激しい地域であることがわかります。人口規模は小さくても、季節によっては大都市以上の魅力度を持つ地域であることが分かります。山間部にはこのような特徴を示す町村が他にも多く見られます。"),
