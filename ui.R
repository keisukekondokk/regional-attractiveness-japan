        ...
        fluidRow(
          ...
          column(
            ...
            box(
              ...
              #--------------------
              h4("具体例の紹介"),
              p("今回提案する地域魅力度指数の理解を深めるため、全国からいくつかの特徴的な市区町村を取り上げる。全ての市区町村を取り上げることはできないが、他にも特徴的な地域魅力度指数を示す市区町村は多くある。何がそのような要因をもたらすのか、時には地図を見ながら、仮説をたてて調べていくと参考になるのではないかと思う"),
              #----------
