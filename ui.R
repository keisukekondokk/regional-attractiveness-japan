        ...
        fluidRow(
          ...
          column(
            ...
            box(
              ...
              box(
                width = NULL, 
                title = h3(icon("fas fa-pen-square"), "ポイント"), 
                background = "navy", 
                solidHeader = FALSE,
                HTML(
